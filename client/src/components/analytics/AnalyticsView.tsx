                    ...
                    <ResponsiveContainer width="100%" height={500}>
                        <RadarChart data={chartData} cx="50%" cy="50%" outerRadius="80%">
                            ...
                            {showPrevious && previousSurvey && (
                                <Radar name={`Previous (${getDateLabel(previousSurvey.date)})`} dataKey="previous" stroke="#F4C542" fill="#F4C542" fillOpacity={0.4} strokeWidth={2} dot={true} />
                            )}
                            {showLatest && (
                                <Radar name={`Latest (${getDateLabel(latestSurvey.date)})`} dataKey="latest" stroke="#7f49b2" fill="#7f49b2" fillOpacity={0.4} strokeWidth={2} dot={true} />
                            )}
